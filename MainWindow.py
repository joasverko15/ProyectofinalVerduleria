...
"}")
        ...
        self.bt_carrito = QtWidgets.QPushButton(self.frame_control)
        self.bt_carrito.setMinimumSize(QtCore.QSize(0, 40))
        self.bt_carrito.setIcon(icon4)
        self.bt_carrito.setIconSize(QtCore.QSize(60, 60))
        self.bt_carrito.setObjectName("bt_carrito")
        self.verticalLayout_3.addWidget(self.bt_carrito)
...
"")
        ...
        self.tabla_productos.setRowCount(6)
...
"alternate-background-color: rgb(0, 85, 0);")
        ...
        self.agregar_nombre_verdurasa = QtWidgets.QLineEdit(self.page_verduras)
        self.agregar_nombre_verdurasa.setStyleSheet("background-color: rgb(0, 170, 0);")
        self.agregar_nombre_verdurasa.setObjectName("agregar_nombre_verdurasa")
        self.verticalLayout_7.addWidget(self.agregar_nombre_verdurasa)
...
"background-color: rgb(85, 255, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_carrito.setText(_translate("MainWindow", "CARRITO"))
